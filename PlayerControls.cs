...
{
    private Rigidbody2D playerBody;    // rigidbosy2d is code given by unity that allows for physics to apply to our playermodel.
    ...
    // Update is called once per frame, this is my form of an observer pattern 
    void Update()             
    {
  //the observer pattern if like a constatnt while statement used when displaying 2d visual games.
        var playerPosition = transform.position;        //transfrom.position is a playerBody function whcih is the players positon on the screen
        ...
        var playervelocity = playerBody.velocity;       //playerBody velocity is the velocity of the player in real time in the game
        ...
        playerBody.velocity = playervelocity;                     //here we call the playerbody 
