...
public class GameManager : MonoBehaviour
{
    ...
    void Start(){
        pongBall = GameObject.FindGameObjectWithTag("spikeball");       //before the frame starts we assign the Ball object to game object pongBall
    }
    ...
    void OnGUI()       //onGui is a unity function that handles GUI events
    {
        ...
        if (rightPLayerScore == gameScore){
            ...
            GUI.Label(new Rect(Screen.width / 2 - 150, 200, 2000, 1000), "RIGHT PLAYER WON");     // Since I am no expert at using unity I had to use a tutorial to help me create this gaming user interface
            pongBall.SendMessage("BallReset", null, SendMessageOptions.RequireReceiver);          // the tutorial I used is on this url https://www.awesomeinc.org/tutorials/unity-pong/ 
        }
    }
